...
export default function Footer() {
  return (
    <div className="">
      <footer div class="bg-white dark:bg-gray-900 mt-10 lg:mt-28">
        <div class="container px-6 py-12 mx-auto">
          <div class="md:flex md:-mx-3 md:items-center md:justify-between">
            ...
            <div class="mt-6 md:mx-3 shrink-0 md:mt-0 md:w-auto">
              <a href="#" class="inline-flex items-center justify-center w-full px-4 py-2 text-sm text-white duration-300 bg-violet-500 rounded-lg gap-x-3 hover:bg-violet-500 focus:ring focus:ring-violet-300 focus:ring-opacity-80">
          ...
          <hr class="my-6 border-gray-200 md:my-10 dark:border-gray-700" />
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              ...
              <div>
                ...
                <div class="flex flex-col items-start mt-5 space-y-2">
                  ...
                  <a href="#" class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">info@e-ticket.com</a>
                </div>
              </div>
            </div>
            ...
            <hr class="my-6 border-gray-200 md:my-10 dark:border-gray-700" />
              ...
              <div class="flex flex-col items-center justify-between sm:flex-row">
                {/* <a href="#">
                  <Image class="w-auto h-7" src="https://merakiui.com/images/full-logo.svg" alt="" width={500} height={50}/>
                </a> */}
